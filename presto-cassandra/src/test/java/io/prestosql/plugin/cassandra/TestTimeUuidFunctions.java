        ...
        extends AbstractTestFunctions
{
    ...
    {
        assertFunction("min_timeuuid(CAST('2013-01-01 00:05:00.000' AS TIMESTAMP))", createVarcharType(36), "89816e00-5331-11e2-8080-808080808080");
        assertFunction("min_timeuuid(CAST('2013-02-02 10:00:00.000' AS TIMESTAMP))", createVarcharType(36), "f5952000-6ca9-11e2-8080-808080808080");
    }

    @Test
    public void testMaxTimeuuid()
    {
        assertFunction("max_timeuuid(CAST('2013-01-01 00:05:00.000' AS TIMESTAMP))", createVarcharType(36), "8981950f-5331-11e2-7f7f-7f7f7f7f7f7f");
        assertFunction("max_timeuuid(CAST('2013-02-02 10:0000.000' AS TIMESTAMP))", createVarcharType(36), "f595470f-6ca9-11e2-7f7f-7f7f7f7f7f7f");
    }
