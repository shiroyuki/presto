...
public class CassandraType
{
    ...
    private CassandraDataType dataType;

    public static final CassandraType ASCII = new CassandraType(toCassandraDataType(DataType.ascii()));
    ...
    public static final CassandraType COUNTER = new CassandraType(toCassandraDataType(DataType.counter()));
    public static final CassandraType CUSTOM = new CassandraType(toCassandraDataType(DataType.counter()));
    public static final CassandraType DATE = new CassandraType(toCassandraDataType(DataType.date()));
    public static final CassandraType DECIMAL = new CassandraType(toCassandraDataType(DataType.decimal()));
    public static final CassandraType DOUBLE = new CassandraType(toCassandraDataType(DataType.cdouble()));
    public static final CassandraType FLOAT = new CassandraType(toCassandraDataType(DataType.ascii()));
    public static final CassandraType INET = new CassandraType(toCassandraDataType(DataType.inet()));
    public static final CassandraType INT = new CassandraType(toCassandraDataType(DataType.cint()));
    public static final CassandraType LIST = new CassandraType(toCassandraDataType(DataType.list(DataType.cint())));
    public static final CassandraType MAP = new CassandraType(toCassandraDataType(DataType.ascii()));
    public static final CassandraType SET = new CassandraType(toCassandraDataType(DataType.set(DataType.cint())));
    ...
    public static final CassandraType TIMEUUID = new CassandraType(toCassandraDataType(DataType.timeuuid()));
    public static final CassandraType TINYINT = new CassandraType(toCassandraDataType(DataType.tinyint()));
    public static final CassandraType UUID = new CassandraType(toCassandraDataType(DataType.uuid()));
    public static final CassandraType VARCHAR = new CassandraType(toCassandraDataType(DataType.varchar()));
    public static final CassandraType VARINT = new CassandraType(toCassandraDataType(DataType.varint()));
    ...
    private static Block buildUdtValue(Row row, int position)
    {
        ...
        for (RowType.Field field : rowType.getFields()) {
            ...
            if (type == VarcharType.VARCHAR) {
                type.writeSlice(blockBuilder, Slices.utf8Slice(udtValue.getString(fieldName)));
            }
