        ...
        implements Module
{
    ...
    public FakerModule(String connectorId, TypeManager typeManager)
    {
    ...
    public void configure(Binder binder)
    {
        ...
        binder.bind(FakerConnectorId.class).toInstance(new FakerConnectorId(connectorId));
        binder.bind(FakerMetadata.class).in(Scopes.SINGLETON);
        binder.bind(FakerClient.class).in(Scopes.SINGLETON);
