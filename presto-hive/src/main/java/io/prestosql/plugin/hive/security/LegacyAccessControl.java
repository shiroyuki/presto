        ...
        implements ConnectorAccessControl
{
    ...
    public void checkCanDropTable(ConnectorSecurityContext context, SchemaTableName tableName)
    {
        ...
        Optional<Table> target = metastoreProvider.apply(((HiveTransactionHandle) context.getTransactionHandle())).getTable(new HiveContext(context.getIdentity()), tableName.getSchemaName(), tableName.getTableName());
