...
@Immutable
public class HivePartitionNameWithContext
{
    ...
    @JsonCreator
    public HivePartitionNameWithContext(
            @JsonProperty("hiveTableName") HiveTableNameWithContext hiveTableName,
    ...
    public static HivePartitionNameWithContext hivePartitionNameWithContext(HiveTableNameWithContext hiveTableName, String partitionName)
    {
        return new HivePartitionNameWithContext(hiveTableName, toPartitionValues(partitionName), Optional.of(partitionName));
    }

    public static HivePartitionNameWithContext hivePartitionNameWithContext(HiveContext context, String databaseName, String tableName, String partitionName)
    {
        return hivePartitionNameWithContext(HiveTableNameWithContext.hiveTableNameWithContext(context, databaseName, tableName), partitionName);
    }

    public static HivePartitionNameWithContext hivePartitionNameWithContext(HiveTableNameWithContext hiveTableName, List<String> partitionValues)
    {
        return new HivePartitionNameWithContext(hiveTableName, partitionValues, Optional.empty());
    }
    ...
    public boolean equals(Object o)
    {
        ...
        HivePartitionNameWithContext other = (HivePartitionNameWithContext) o;
